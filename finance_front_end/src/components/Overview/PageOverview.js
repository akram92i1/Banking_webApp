    ...
    return (
        <div className="p-6 flex-grow overflow-auto relative">
            ...
            <div className="glass-card rounded-3xl p-6 mb-6 relative overflow-hidden">
                <div className="flex items-center justify-between">
                    ...
                    <div className="glass-card rounded-2xl px-4 py-2 flex items-center gap-3">
                        <div className="relative">
                            <div className={`w-4 h-4 rounded-full ${connectionStatus === 'connected' ? 'bg-emerald-400' :
                ...
                {/* Shimmer effect - Kept for premium feel but can remove if 'solid' requires it. Leaving it for now as it's not 'floating' */}
